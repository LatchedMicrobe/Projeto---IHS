	pcihellocore u0 (
		.buttonport_external_connection_export  (<connected-to-buttonport_external_connection_export>),  // buttonport_external_connection.export
		.greenport_external_connection_export   (<connected-to-greenport_external_connection_export>),   //  greenport_external_connection.export
		.hexport2_external_connection_export    (<connected-to-hexport2_external_connection_export>),    //   hexport2_external_connection.export
		.hexport3_external_connection_export    (<connected-to-hexport3_external_connection_export>),    //   hexport3_external_connection.export
		...
		.redport_external_connection_export     (<connected-to-redport_external_connection_export>)      //    redport_external_connection.export
	);
